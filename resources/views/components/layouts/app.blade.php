            ...
            <x-menu activate-by-route>
                ...
                @if($user = auth()->user())
                    ...
                    <x-list-item :item="$user" value="name" sub-value="email" no-separator no-hover class="-mx-2 !-my-2 rounded">
                        <x-slot:actions>
                            <x-button icon="o-power" class="btn-circle btn-ghost btn-xs" tooltip-left="logoff" no-wire-navigate @click="$dispatch('logout')"/>
                        </x-slot:actions>
                    </x-list-item>
                ...
                <x-menu-sub title="Warehouse" icon="o-wrench-screwdriver">
                    ...
                    <x-menu-item title="Products" icon="o-cube" link="####" />
                </x-menu-sub>
            </x-menu>
        </x-slot:sidebar>
